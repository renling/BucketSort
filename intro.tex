...
In more detail, let $Z$ be a statistical security parameter that controls the error probability. 
...
In Section~\ref{sec:extensions}, we will discuss how to extend our algorithms to use constant client storage, achieve better asymptotic complexity, and preserve locality.
